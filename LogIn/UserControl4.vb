...
Public Class UserControl4
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        SessionManager.CurrentEmployeeId = 0 ' Clear the current employee ID

        ' Close all open forms except the Login form
        For Each openForm As Form In Application.OpenForms
            If Not openForm Is LogIn Then
                openForm.Hide() ' Hide all forms except Login
            End If
        Next
        ...
        ' Optionally, bring the Login form to the front
        LogIn.BringToFront()
    End Sub
